<template>
  <div class="goods-info">
    <transition @before-enter="beforeEnter" @enter="enter" @after-enter="afterEnter">
      <div ref="ball" class="goods-info-ball" v-show="ballFlag"></div>
    </transition>
    ...
    <div class="goods-info-content">
      ...
      <div class="goods-info-container">
        <p>
          市场价：
          <span>￥{{goodsInfo.market_price}}</span>&nbsp;销售价：
          <span>￥{{goodsInfo.sell_price}}</span>
        </p>
        <p>
          <span class="goods-info-text">购买数量：</span>
          <button class="goods-info-btn" @click="delCount">-</button>
          <span class="goods-info-text-num">{{count}}</span>
    ...
    <div class="goods-info-content">
      ...
      <div class="goods-info-container-btn">
        <van-button
          class="goods-info-container-btn-1"
          plain
          type="info"
          size="large"
          @click="goDesc(id)"
